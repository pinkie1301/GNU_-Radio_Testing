...
class USRP_trans_img(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.access_key = access_key = '11010011101100101010101011001110'
        self.samp_rate = samp_rate = 32000
        self.hdr_format = hdr_format = digital.header_format_default(access_key, 0)
        self.center_freq = center_freq = 2.4e9
        self.QPSK_constellation_0 = QPSK_constellation_0 = digital.constellation_dqpsk().base()
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\pinkie\\Documents\\GNU_ Radio_Testing\\USRP_trans_img\\莊東穎教授本人財產.bin', False, 0, 0)
        ...
        self.msg_connect((self.digital_protocol_formatter_async_0, 'header'), (self.pdu_pdu_to_tagged_stream_1, 'pdus'))
        self.msg_connect((self.digital_protocol_formatter_async_0, 'payload'), (self.pdu_pdu_to_tagged_stream_1_0, 'pdus'))
        ...
        self.connect((self.pdu_pdu_to_tagged_stream_1, 0), (self.blocks_tagged_stream_mux_0, 0))
        self.connect((self.pdu_pdu_to_tagged_stream_1_0, 0), (self.blocks_tagged_stream_mux_0, 1))
