...
import qam16_xmt_and_rcv_epy_block_0 as epy_block_0  # embedded python block
import qam16_xmt_and_rcv_epy_block_0_0 as epy_block_0_0  # embedded python block
import sip
import threading



class qam16_xmt_and_rcv(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "16QAM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("16QAM")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qam16_xmt_and_rcv")
        ...
        ##################################################
        self.sps = sps = 4
        self.qam16 = qam16 = digital.constellation_rect([-3-3j, -1-3j, 1-3j, 3-3j, -3-1j, -1-1j, 1-1j, 3-1j, -3+1j, -1+1j, 1+1j, 3+1j, -3+3j, -1+3j, 1+3j, 3+3j], [0, 1, 3, 2, 4, 5, 7, 6, 12, 13, 15, 14, 8, 9, 11, 10],
        4, 2, 2, 1, 1).base()
        ...
        self.phase_bw = phase_bw = 0.08
        self.hdr_format = hdr_format = digital.header_format_default(access_key, 0)
        self.excess_bw = excess_bw = 0.35
        self.center_freq = center_freq = 2.4e9
        self.algo = algo = digital.adaptive_algorithm_lms( qam16, 0.0005).base()
        self.Output_File_Path = Output_File_Path = "./outputs/output_qam16.png"
        ...
        self.qtgui_const_sink_x_1_0.set_y_axis((-4), 4)
        self.qtgui_const_sink_x_1_0.set_x_axis((-4), 4)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_1_0_win, 1, 2, 1, 2)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.digital_linear_equalizer_0 = digital.linear_equalizer(15, 2, algo, True, [ ], 'corr_est')
        ...
        self.blocks_tag_debug_0 = blocks.tag_debug(gr.sizeof_char*1, 'rx_access_code_debug', "packet_len")
        ...
        self.blocks_repack_bits_bb_0_0 = blocks.repack_bits_bb(8, 2, "packet_len", False, gr.GR_MSB_FIRST)
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(4, 1, "", False, gr.GR_MSB_FIRST)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(0.316)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.qtgui_const_sink_x_1_0, 0))
        ...
        self.connect((self.digital_constellation_decoder_cb_0, 0), (self.blocks_uchar_to_float_0_0, 0))
        ...
        self.connect((self.digital_fll_band_edge_cc_0, 0), (self.digital_symbol_sync_xx_0_0, 0))
    ...
    def set_qam16(self, qam16):
        self.qam16 = qam16
        self.digital_constellation_decoder_cb_0.set_constellation(self.qam16)
...
def main(top_block_cls=qam16_xmt_and_rcv, options=None):
