...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.epy_block_0 = epy_block_0.blk(FileName="./input_video.ts", Pkt_len=256)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, "./outputs/output.tmp", False)
