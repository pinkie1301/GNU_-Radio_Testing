...
# Title: USRP Transmit and Receive
# Author: pinkie
...
import sip
import threading
import usrp_xmt_and_rcv_epy_block_0 as epy_block_0  # embedded python block
import usrp_xmt_and_rcv_epy_block_0_0 as epy_block_0_0  # embedded python block



class usrp_xmt_and_rcv(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "USRP Transmit and Receive", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("USRP Transmit and Receive")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "usrp_xmt_and_rcv")
        ...
        self.usrp_rate = usrp_rate = 2048e3
        ...
        self.epy_block_0 = epy_block_0.blk(FileName="./inputs/input_img.png", Pkt_len=256)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, "./outputs/output.png", False)
...
def main(top_block_cls=usrp_xmt_and_rcv, options=None):
