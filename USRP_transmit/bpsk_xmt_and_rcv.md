...
- name: digital_costas_loop_cc_0
  ...
  parameters:
    affinity: ''
    alias: ''
    comment: "\u540C\u6642\u6821\u6B63\u5F8C\u7E8C constellation \u983B\u7387\u504F\
      \u79FB\u548C\u76F8\u4F4D\u504F\u79FB\nOrder:\n2 -> BPSK\n4 -> QPSK\n8 -> 8PSK"
    maxoutbuf: '0'
    minoutbuf: '0'
    order: '2'
...
- name: digital_symbol_sync_xx_0
  ...
  states:
    ...
    bus_source: false
    bus_structure: null
    coordinate: [296, 576.0]
    rotation: 0
    state: true
- name: epy_block_0
  id: epy_block
  parameters:
    FileName: '"./inputs/input_img.png"'
    Pkt_len: '256'
    ...
    comment: 'Filename is specified on the command line, e.g.:
      ...
      The EPB block functions:

      1. Send a preamble (32bits "11100001010110101110100010010011") to allow the
      receiver to synchronize.

      2. Read the file in "Pkt_Len" chunks.

      3. Convert the data to Base64, which produces 4 bytes of output for every 3
      bytes of input.

      4. Send each Base64 chunk with revised "packet_len" tags.

      5. Send a post-file filler to assure that any buffers have been flushed.'
    maxoutbuf: '0'
    minoutbuf: '0'
  states:
...
- name: epy_block_0_0
  ...
  parameters:
    ...
    affinity: ''
    alias: ''
    comment: 'Strip preamble and postamble

      Convert Base64 to original file content'
    maxoutbuf: '0'
    minoutbuf: '0'
  states:
...
- [fft_filter_xxx_0_0_0, '0', uhd_usrp_sink_0, '0']
...
- [virtual_source_0_0, '0', blocks_repack_bits_bb_0_0, '0']
- [virtual_source_0_0, '0', digital_constellation_modulator_0, '0']
