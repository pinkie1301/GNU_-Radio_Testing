...
import time
import qpsk_xmt_and_rcv_epy_block_0 as epy_block_0  # embedded python block
import qpsk_xmt_and_rcv_epy_block_0_0 as epy_block_0_0  # embedded python block
import sip
import threading



class qpsk_xmt_and_rcv(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QPSK mod", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpsk_xmt_and_rcv")
        ...
        self.uhd_usrp_sink_0 = uhd.usrp_sink(
            ",".join(("", 'num_send_frames=128,send_frame_size=4096')),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
                channels=list(range(0,1)),
    ...
    def get_x310_ID(self):
        return self.x310_ID

    def set_x310_ID(self, x310_ID):
        self.x310_ID = x310_ID
    ...
    def get_b210_ID_0(self):
        return self.b210_ID_0

    def set_b210_ID_0(self, b210_ID_0):
        self.b210_ID_0 = b210_ID_0
...
def main(top_block_cls=qpsk_xmt_and_rcv, options=None):
