...
import time
import USRP_trans_img_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class USRP_trans_img(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "USRP_trans_img")
        ...
        self.epy_block_0 = epy_block_0.blk(FileName="C:/Users/pinkie/Downloads/gnu-radio-logo-768x576.png", Pkt_len=60)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\pinkie\\Documents\\GNU_ Radio_Testing\\USRP_trans_img\\gr-control\\Receivers\\output.tmp', False)
        ...
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.digital_protocol_parser_b_0, 0))
        ...
        self.connect((self.digital_header_payload_demux_0, 0), (self.blocks_repack_bits_bb_0, 0))
...
def main(top_block_cls=USRP_trans_img, options=None):
    if options is None:
