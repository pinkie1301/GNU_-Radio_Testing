...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.usrp_rate = usrp_rate = 1536e3
        ...
        self.epy_block_0 = epy_block_0.blk(FileName="./gnu-radio-logo-768x576.png", Pkt_len=60)
        ...
        self.connect((self.fft_filter_xxx_0_0_0, 0), (self.uhd_usrp_sink_0, 0))
