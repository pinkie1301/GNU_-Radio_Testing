...
import time
import pkt_comb_usrp_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class pkt_comb_usrp(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "pkt_comb_usrp")
...
def main(top_block_cls=pkt_comb_usrp, options=None):
    if options is None:
